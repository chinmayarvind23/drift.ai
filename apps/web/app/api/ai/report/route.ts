...
export async function POST(request: Request) {
  ...
  const prompt = [
    ...
    "- Name the monthly overspend and what that means over a month.",
    "### Why it may have happened",
    "- Connect the behavior tag and note to the pattern.",
    "- Explain whether intercept decisions show intentional spending, automatic spending, or mixed signals.",
    "### What to do next",
    "- Give one friction-removal step for the next 7 days.",
    "- Give one replacement or default for the next 30 days.",
    "- Give one keep-or-cut rule for deciding whether this pattern should stay.",
